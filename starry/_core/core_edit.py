...
class OpsYlm(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        print("dotr value: ", self._c_ops.dotR)
...
class OpsLD(object):
    ...
    def eval_X(self, theta, xo, yo, zo, ro, inc, obl, u, f):
        flux = self.flux(xo, yo, zo, ro, u)
        # X = tt.reshape(flux, (-1, 1))
        X = flux.reshape((-1,1))
        return X
    ...
    def X(
        ...
        if self._reflected:
           pass
            ...
            [print("type of X: ", type(sec.map.ops))
             for i, sec in enumerate(self.secondaries)]
